...
export const MusicProvider = ({ children }) => {
	const [allSongs, setAllSongs] = useState(songsList);
	const [currentTrack, setCurrentTrack] = useState(songsList[0]);
	...
	return <MusicContext.Provider value={{ allSongs, currentTrack, currentTrackIndex, handlePlaySong, currentTime, setCurrentTime, formatTime, duration, setDuration, nextTrack, prevTrack, play, pause, isPlaying, volume, setVolume, playlists, createPlaylist, addSongToPlaylist, setCurrentTrack, deletePlaylist }}>{children}</MusicContext.Provider>;
};
